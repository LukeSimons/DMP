...
echo "Test 1:"
echo "Thermal Current"
echo 

echo "Warning! This test will take an extremely long time to complete!"

./main -p 0.0 -m 0.0 -z 0.5 -f 5.0 -i 5000000 -j 40000 -c 1.0 -sa 1
#./main -p 0.0 -m 0.0 -z 1.0 -f 100.0 -i 50000 -j 400 -c 1.0 -sa 10
