...
potentials=("-0.6" "-0.8" "-1.0" "-1.2" "-1.4" "-1.6" "-1.8" "-2.0" "-2.5" "-3.0" "-3.5" "-4.0" "-5.0" "-7.0" "-9.0" "-11.0" "-13.0" "-15.0" "-17.0" "-19.0" "-22.0" "-25.0" )
#potentials=("-100.0")
...
do
	...
	do
		./main -p ${pot} -i 100000 -j 100000 -m ${BMag} -n 1 -b 1.0 -l 1.0 -u 1.0 -o _${BMag}_${pot}.txt -c 1.0 -s 1.0
...
#		NOTE! Coefficient '51.8996' only valid for T=1eV, Ions, impinging on a 10e-6m sphere
		cat Tests/Currents.txt | awk -v V=${pot} -v bmag=${BMag} '
		{
			print bmag,51.8996*bmag,pot, $1,$2;
		}' >> Out.txt
	done
done
